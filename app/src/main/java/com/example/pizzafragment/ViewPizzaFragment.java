...
public class ViewPizzaFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //Si se utiliza safe-args no es necesario indicar la cadena String ARG_PIZZA dentro del Bundle, se implementa directamente el método getPizza().
        Pizza pizza= ViewPizzaFragmentArgs.fromBundle(getArguments()).getPizza();
        tvName.setText(pizza.getName());
        tvDescription.setText(pizza.getDescripcion());
